...
def main():
    show_header()
    location_text = input("From where do you wish to het the weather report (e.g. Portland, US)?: ")

    # f is from fstring (Python 3.9) and it's used for other .format formula
...
def convert_plaintext_location(location_text):
    ...
    # t = city, state, country  # example of a tuple
    # t[0]
